...
class CacheManager:
    ...
    def __init__(
        ...
        self.prefix_cache = SqliteDict(
            prefix_cache_path, autocommit=True, timeout=10, journal_mode="WAL"
        )
        self.prompt_history = SqliteDict(
            prompt_history_path, autocommit=True, timeout=10, journal_mode="WAL"
        )
